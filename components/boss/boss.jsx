...
const Boss = ({image,name,urven,time,phone,gamil,wimg1, wname1,wurvern1,wtel1,wgmail1 ,wimg2,wname2,wurvern2,wtel2,wgmail2}) => {
    return (
        ...
        >
           ...
           <div className='flex w-full border-t-2 border-oqroq'>
           <Image className=' w-28 h-28 rounded-md' src={wimg2} alt='img' />
           <div className='w-96 text-start ml-5 border-l-2 border-oqroq pl-2'>
           <p className='text-grenn'>{wname2}</p>
             <p className='text-grenn'><span className='text-md text-blue'>Lavozimi: </span>{wurvern2}</p>
             <p className='text-grenn'><span className='text-md text-blue'>Telefon: </span>{wtel2}</p>
             <p className='text-grenn'><span className='text-md text-blue'>E-Mail: </span>{wgmail2}</p>
           </div>
           </div>
        </div>
    );
